<header>
    <img src="img/ralogo_monogram.png" alt="" class="logo">
    <p>Roux Academy<br>
        Art • Media • Design
    </p>
    <div>
...
<nav>
    <ul>
        <li><a href="rouxpro.php">HOME</a></li>
        <li><a href="artists.php">ARTISTS</a></li>
        <li><a href="schedule.php">SCHEDULE</a></li>
        <li><a href="venue.php">VENUE/TRAVEL</a></li>
        <li><a href="register.php">REGISTER</a></li>
        <li><a href="usuarios.php">ASISTENTES</a></li>
        <li><a href="edit_artist.php">EDITAR</a></li>
